...
com as diretrizes do NCCN. Este paciente não apresenta evidência de
...
capaz de produzir esperma, concorda em não doar esperma e usa
contracepção altamente eficaz. Para mulheres, elas não estão grávidas ou
amamentando e usam contracepção altamente eficaz se em idade fértil,
abstendo-se de amamentar durante o período de intervenção do estudo.
