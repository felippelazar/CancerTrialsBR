...
adenocarcinoma gastroesofágico localmente avançado irressecável ou
metastático 1L previamente não tratado, que não possui câncer
HER2/neu-positivo. Este paciente não deve necessitar de ressecção
tumoral durante o tratamento e não recebeu terapia sistêmica prévia no
cenário recorrente ou metastático. Eles forneceram uma biópsia tumoral
recente e se recuperaram de quaisquer eventos adversos de terapias
anticâncer anteriores para menos de Grau 1 ou linha de base. O paciente
tem doença mensurável de acordo com os critérios RECIST 1.1, um status
de desempenho ECOG de 0 ou 1 e uma expectativa de vida de pelo menos 6
meses. Eles podem ter histórico de hepatite B ou C, desde que a carga
viral seja indetectável, e se forem HIV-positivos, sua condição está bem
