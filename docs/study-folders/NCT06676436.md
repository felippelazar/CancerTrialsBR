...
**Paciente Ideal:** Pacientes adultos, tanto do sexo feminino quanto
masculino, com 18 anos ou mais, com câncer de mama irressecável ou
metastático caracterizado por positividade do Receptor de Estrogênio (≥
1%) e status HER2-negativo (IHC 0, 1+ ou 2+/ISH negativo) no início do
tratamento de primeira linha são elegíveis. Esses pacientes devem ter
recebido um inibidor de CDK4/6 como parte do tratamento de primeira
linha e ter descontinuado permanentemente esse tratamento devido à
progressão da doença, morte ou qualquer outro motivo. Pacientes com
doença recorrente são elegíveis sem a necessidade de uma nova biópsia, a
menos que seu tumor primário mostre um padrão de receptor diferente de
ER ≥ 1% e HER2-negativo. A exclusão se aplica àqueles com câncer
concomitante diagnosticado dentro de cinco anos de seu câncer de mama
HR-positivo HER2-negativo, exceto para cânceres de pele não melanoma não
metastáticos ou neoplasias in situ/benignas. Além disso, pacientes que
estão participando ou participaram de um estudo intervencional cego no
momento da coleta de dados são excluídos.
